    ...
    <div className="w-full h-full bg-gradient-to-r from-[#F5FFF2] to-[#E5FFE9] py-20">
      ...
      <div className="flex items-center justify-center">
        <div className="bg-white border border-main rounded-full px-7 py-4 flex gap-x-2">
          <Link
            className="px-7 py-3 rounded-full hover:bg-main hover:text-white transition-all duration-500"
            to={"/"}
          >
            All
          </Link>
      ...
      <div className="imgContainer grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 wrapper mt-12">
        <div className="flex flex-col gap-y-1 group relative p-2 border border-black/40 rounded-md">
          ...
          <div className="mt-3 flex justify-between items-center">
            ...
            <div>
              <button className="cursor-pointer px-7 py-2 rounded-full bg-main text-white opacity-0 group-hover:opacity-100 transition duration-300">
                VIEW DETAILS
              </button>
            </div>
          </div>
      ...
      <div className=" mt-12 flex justify-center items-center">
        <button className="cursor-pointer px-7 py-3 border border-main rounded-full hover:bg-main hover:text-white transition-all duration-500">Show All </button>
      </div>
    </div>
  );
};
